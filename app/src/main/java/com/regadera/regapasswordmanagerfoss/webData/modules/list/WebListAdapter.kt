...
class WebListAdapter: RecyclerView.Adapter<WebListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.text_web_webname.text = currentItem?.website
        holder.itemView.text_web_username.text = currentItem?.userName
        holder.itemView.text_web_password.text = currentItem?.mainPassword
    }
