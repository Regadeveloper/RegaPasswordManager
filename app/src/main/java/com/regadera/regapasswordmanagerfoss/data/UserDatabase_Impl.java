...
public final class UserDatabase_Impl extends UserDatabase {
  private volatile UserDaoInterface _userDaoInterface;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `user_table` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `userName` TEXT NOT NULL, `mainPassword` TEXT NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '72219af9f61014f05dd530b17f844512')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsUserTable.put("mainPassword", new TableInfo.Column("mainPassword", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoUserTable.equals(_existingUserTable)) {
          return new RoomOpenHelper.ValidationResult(false, "user_table(com.regadera.regapasswordmanagerfoss.data.User).\n"
                  + " Expected:\n" + _infoUserTable + "\n"
                  + " Found:\n" + _existingUserTable);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "72219af9f61014f05dd530b17f844512", "186df779299ac0d79386409e925ef556");
  ...
  public UserDaoInterface userDao() {
    if (_userDaoInterface != null) {
      ...
      synchronized(this) {
        if(_userDaoInterface == null) {
          _userDaoInterface = new UserDaoInterface_Impl(this);
        }
        return _userDaoInterface;
      }
    }
